...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/rival-schools-recomp/total)](https://github.com/Alexbeav/rival-schools-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/rival-schools-recomp/latest/total)](https://github.com/Alexbeav/rival-schools-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/rival-schools-recomp)](https://github.com/Alexbeav/rival-schools-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Rival Schools: United by Fate** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-00681 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00681 |
| Discs | 1 |
| Supported dump | Redump `Rival Schools - United by Fate (USA) (Disc 1) (Arcade Disc).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/rival-schools-recomp/releases)
   and extract it into a writable folder.
2. Start `Rival_Schools_United_by_Fate` (`.exe` on Windows).
...
programs. This kit is the **Arcade Disc** (disc 1, SLUS-00681). The **evolution disc** (disc 2, slus-00771) is its own kit:
[Rival Schools: Evolution Disc](https://github.com/Alexbeav/rival-schools-evolution-recomp). Install the
...
named `diagnostic-mode.txt` next to `Rival_Schools_United_by_Fate.exe` and start the game as
usual, or run `Rival_Schools_United_by_Fate.exe --diagnostic`. Reproduce the problem, quit, then
run `Rival_Schools_United_by_Fate.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
