...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Rival Schools: United by Fate",
    .project_root_env = "RIVAL_SCHOOLS_UNITED_BY_FATE_PROJECT_ROOT",
    .build_dir_env = "RIVAL_SCHOOLS_UNITED_BY_FATE_BUILD_DIR",
    .force_setup_env = "RIVAL_SCHOOLS_UNITED_BY_FATE_FORCE_SETUP",
